...
export const LABELS = {
  ...
  bars: {
    ...
    financial: { en: "Money a bidder had to show — turnover, or cash and credit, whichever the notice set higher", bn: "দরদাতাকে যে অর্থ দেখাতে হতো — লেনদেন, নয়তো নগদ ও ঋণসীমা, বিজ্ঞপ্তি যেটি বেশি ধরেছে" },
  ...
  barsShort: {
    ...
    financial: { en: "Money to be shown", bn: "দেখাতে হওয়া অর্থ" },
...
export const CASE = {
  ...
  words: {
    ...
    liquid: { en: "Cash or credit line demanded", bn: "দাবি করা নগদ বা ঋণসীমা" },
...
export const CASES = {
  single_bid: {
    ...
    markRead: {
      en: "Two documents sold, one bid received, one found responsive. That line is the whole record of competition for {{cases.single_bid.value|taka}} of public money. The notice published no qualification criteria of its own either. Where the conditions should be, it says only that they are as per the tender data sheet, and that sheet is not in the published file. One bid is not wrong on its own. A road nobody else wants to build is a road nobody else bids on. What the documents can settle is how much of the money moved this way.",
      bn: "দুটি নথি বিক্রি, একটি দর জমা, একটি গ্রহণযোগ্য। জনগণের {{cases.single_bid.value|taka}} টাকার প্রতিযোগিতার পুরো নথি ওই একটি লাইন। এই বিজ্ঞপ্তিতে নিজস্ব কোনো যোগ্যতার শর্তও প্রকাশ করা হয়নি। যেখানে শর্ত থাকার কথা, সেখানে কেবল লেখা আছে শর্ত টেন্ডার ডেটা শিট অনুযায়ী, আর সেই শিট প্রকাশিত ফাইলে নেই। একটি দর নিজে থেকে অন্যায় নয়। যে সড়ক আর কেউ বানাতে চায় না, সেখানে আর কেউ দর দেয় না। নথিগুলো যা মীমাংসা করতে পারে তা হলো, এই টাকার কত অংশ ওই পথে গেছে।",
    },
    after: [
      {
  ...
  no_criteria: {
    ...
    p: [
      {
        en: "A road in Khulna, and the second largest contract in this report's twelve scenes. {{cases.no_criteria.package|work}} — the widening and improvement of the Shipyard Road — was signed for {{cases.no_criteria.value|taka}}, half again as much as the Chattogram link road the report opened on. The {{cases.no_criteria.organization|org}} published the notice on {{cases.no_criteria.published|date}}, re-tendering work it had put out before. Three companies bought the document; two bid; one bid survived the evaluation.",
        bn: "খুলনার একটি সড়ক, আর এই প্রতিবেদনের বারোটি দৃশ্যের মধ্যে দ্বিতীয় বৃহত্তম চুক্তি। {{cases.no_criteria.package|work}} — শিপইয়ার্ড সড়ক প্রশস্তকরণ ও উন্নয়ন — {{cases.no_criteria.value|taka}} টাকায় স্বাক্ষরিত হয়, যা এই প্রতিবেদন যে চট্টগ্রামের সংযোগ সড়ক দিয়ে শুরু হয়েছিল তার দেড় গুণ। {{cases.no_criteria.organization|org}} {{cases.no_criteria.published|date}} তারিখে বিজ্ঞপ্তিটি প্রকাশ করে; এর আগেও একবার আহ্বান করা কাজ দ্বিতীয়বার আহ্বান করে। তিনটি প্রতিষ্ঠান নথি কেনে; দুটি দর দেয়; মূল্যায়ন পেরোয় একটি দর।",
      },
    ],
    markLabel: {
    ...
    markRead: {
      en: "Three words, for {{cases.no_criteria.value|taka}} of road. That is the notice's whole account of what a company had to prove. It points at a tender data sheet, and the data sheet is not published. No years of experience, no turnover figure, no cash requirement. There is nothing to argue is too high, and nothing to show that the two companies which bid were held to the same test. Two bid, one was set aside, and the notice gives no reason.",
      bn: "তিনটি শব্দ, {{cases.no_criteria.value|taka}} টাকার একটি সড়কের জন্য। একটি প্রতিষ্ঠানকে কী প্রমাণ করতে হবে, বিজ্ঞপ্তিতে তার পুরো বিবরণ এটুকুই। এটি একটি টেন্ডার ডেটা শিটের দিকে আঙুল দেখায়, আর সেই শিট প্রকাশ করা হয়নি। অভিজ্ঞতার বছর নেই, লেনদেনের অঙ্ক নেই, নগদের শর্ত নেই। বেশি বলে আপত্তি তোলার কিছু নেই, আর দর দেওয়া দুটি প্রতিষ্ঠানকে একই মাপকাঠিতে মাপা হয়েছে — এটি দেখানোরও কিছু নেই। দুটি দর দেয়, একটিকে সরিয়ে রাখা হয়, আর বিজ্ঞপ্তিতে কারণ লেখা নেই।",
    },
    after: [
      {
  ...
  high_bar: {
    ...
    markRead: {
      en: "The job was a fire-protection system: {{cases.high_bar.package|work}}. It was worth {{cases.high_bar.value|taka}}. To be allowed to bid, a company had to hold {{cases.high_bar.liquid|taka}} in cash or a credit line — more than the whole contract was worth — and to show {{cases.high_bar.turnover_crore|cr}} in average yearly turnover, which is {{cases.high_bar.financial_ratio|x2}} the value of the work. A firm that could install the system but could not show money on that scale was not allowed to offer a price at all, however good the price would have been. This is not one odd notice: {{bars.financial_above_1x|n}} notices here set the money bar above what the contract turned out to be worth. Two companies bid. One was set aside, and no reason is published.",
      bn: "কাজটি ছিল একটি অগ্নিনির্বাপণ ব্যবস্থা: {{cases.high_bar.package|work}}। এর মূল্য {{cases.high_bar.value|taka}}। দর দেওয়ার অনুমতি পেতে একটি প্রতিষ্ঠানের হাতে নগদ বা ঋণসীমা হিসেবে থাকতে হতো {{cases.high_bar.liquid|taka}} — পুরো চুক্তির মূল্যের চেয়েও বেশি — আর দেখাতে হতো বার্ষিক গড় লেনদেন {{cases.high_bar.turnover_crore|cr}}, যা কাজের মূল্যের {{cases.high_bar.financial_ratio|x2}}। যে প্রতিষ্ঠান ব্যবস্থাটি বসাতে পারত, কিন্তু এই মাপের অর্থ দেখাতে পারত না, তাকে দর দিতেই দেওয়া হয়নি — দরটি যত ভালোই হতো। এটি একটিমাত্র বিসদৃশ বিজ্ঞপ্তি নয়: এখানকার {{bars.financial_above_1x|n}}টি বিজ্ঞপ্তিতে অর্থের সীমা বাঁধা হয়েছে চুক্তির প্রকৃত মূল্যের চেয়েও উঁচুতে। দুটি প্রতিষ্ঠান দর দেয়। একটিকে সরিয়ে রাখা হয়, আর কারণ প্রকাশ করা হয়নি।",
    },
    after: [
      {
  ...
  late_signing: {
    ...
    markRead: {
      en: "Five companies bought the document and all five bid. Three of the five were set aside. The notice does not say which three, or why. Then the clock. The award notice records that the letter of acceptance went out on {{cases.late_signing.noa|date}} and that a {{cases.late_signing.cap|n}}-day limit applied to signing the contract. It was signed on {{cases.late_signing.signed|date}} — {{cases.late_signing.days|n}} days later, {{cases.late_signing.overrun|n}} days past the deadline the same page states. Delay on its own is not wrongdoing. Files move slowly and money moves with them. But the deadline is the notice's own, and how often it is missed is something these documents can answer. The winning firm, {{cases.late_signing.winner|firm}}, holds {{cases.late_signing.winner_contracts|n}} contracts here.",
      bn: "পাঁচটি প্রতিষ্ঠান নথি কেনে, পাঁচটিই দর দেয়। পাঁচটির তিনটি সরিয়ে রাখা হয়। কোন তিনটি, বা কেন, বিজ্ঞপ্তিতে লেখা নেই। এরপর সময়ের হিসাব। চুক্তির বিজ্ঞপ্তিতেই লেখা আছে, কাজের চিঠি গেছে {{cases.late_signing.noa|date}} তারিখে, আর চুক্তি স্বাক্ষরের জন্য প্রযোজ্য সীমা ছিল {{cases.late_signing.cap|n}} দিন। চুক্তি হয় {{cases.late_signing.signed|date}} তারিখে — {{cases.late_signing.days|n}} দিন পরে, একই পৃষ্ঠায় লেখা সীমার {{cases.late_signing.overrun|n}} দিন পার করে। দেরি নিজে থেকে অন্যায় নয়। ফাইল ধীরে চলে, টাকাও তার সঙ্গে চলে। তবু সময়সীমাটি বিজ্ঞপ্তির নিজেরই, আর তা কতবার পার হয়েছে — এই প্রশ্নের উত্তর নথিগুলো দিতে পারে। বিজয়ী প্রতিষ্ঠান {{cases.late_signing.winner|firm}}-এর হাতে এখানে {{cases.late_signing.winner_contracts|n}}টি চুক্তি।",
    },
    after: [
      {
  ...
  rule_stack: {
    tender: "1083760",
    rec: ["bids", "responsive", "value", "days", "cap"],
    p: [
      {
    ...
    markRead: {
      en: "An open tender, and the first condition is that the bidder already be on somebody's list. The standard document says the opposite. It says there shall not be any pre-conditions whatsoever for the sale of tender documents, and it confines enlistment to the limited method. But read the whole sentence before using it. Enlistment with {{cases.rule_stack.organization|org}} <em>or</em> any other government, semi-government or autonomous body will do, and so will a reputed bonafide firm. As written, it shuts out only a company never enlisted anywhere in the public sector. The wording is not this office's own either: the same sentence appears in {{cases.rule_stack.reuse|n}} notices in this set. This tender fails {{cases.rule_stack.deviations|n}} of the {{counts.rules|n}} clause tests. {{cases.rule_stack.duty_n|n}} of the {{cases.rule_stack.deviations|n}} are against clauses worded as duties. The other {{cases.rule_stack.band_n|n}} are against a figure a document recommends, or a note, or guidance. That difference is the whole of the rules section below. And the dates: {{cases.rule_stack.days|n}} days from acceptance to signing, against the {{cases.rule_stack.cap|n}} this contract's size allows. Two lines under them, the notice's own field asks whether the contract was signed in due time. The answer printed is yes.",
      bn: "খোলা দরপত্র, আর প্রথম শর্তটিই হলো দরদাতাকে আগে থেকেই কারও তালিকায় থাকতে হবে। আদর্শ দস্তাবেজ ঠিক উল্টো কথা বলে। সেখানে লেখা, দরপত্রের নথি বিক্রির ক্ষেত্রে কোনো পূর্বশর্তই থাকবে না, আর তালিকাভুক্তির শর্ত কেবল সীমিত পদ্ধতিতেই চলে। তবু ব্যবহারের আগে পুরো বাক্যটি পড়ে নেওয়া দরকার। {{cases.rule_stack.organization|org}} <em>অথবা</em> অন্য যেকোনো সরকারি, আধা-সরকারি বা স্বায়ত্তশাসিত সংস্থার তালিকায় থাকলেই চলবে, এমনকি সুপরিচিত প্রকৃত কোনো প্রতিষ্ঠান হলেও চলবে। যেভাবে লেখা, তাতে কেবল সেই প্রতিষ্ঠানই বাদ পড়ে যা সরকারি খাতের কোথাও কখনো তালিকাভুক্ত হয়নি। ভাষাটি এই দপ্তরের নিজেরও নয়: একই বাক্য এই সংকলনের {{cases.rule_stack.reuse|n}}টি বিজ্ঞপ্তিতে আছে। {{counts.rules|n}}টি ধারা-পরীক্ষার {{cases.rule_stack.deviations|n}}টিতে এই দরপত্রটি বিচ্যুত। ওই {{cases.rule_stack.deviations|n}}টির {{cases.rule_stack.duty_n|n}}টি এমন ধারার বিপরীতে, যেগুলো বাধ্যতা হিসেবে লেখা। বাকি {{cases.rule_stack.band_n|n}}টি সুপারিশ করা অঙ্ক, একটি নোট বা নির্দেশনার বিপরীতে। এই পার্থক্যটিই নিচের নিয়ম-অংশের পুরোটা। আর তারিখ: কাজের চিঠি থেকে স্বাক্ষর পর্যন্ত {{cases.rule_stack.days|n}} দিন, যেখানে এই মাপের চুক্তির প্রাপ্য {{cases.rule_stack.cap|n}} দিন। তার দুই লাইন নিচেই বিজ্ঞপ্তির নিজের ঘরে প্রশ্ন, চুক্তিটি যথাসময়ে স্বাক্ষরিত হয়েছে কি না। ছাপা উত্তর: হ্যাঁ।",
    },
    after: [
      {
  ...
  all_rejected: {
    ...
    markRead: {
      en: "{{cases.all_rejected.sold|n}} documents sold, {{cases.all_rejected.bids|n}} bids received, none ruled responsive — and a signed contract underneath. Two readings fit that page. Either the zero is an error in the entry, or it describes the evaluation. The page does not say which. It names {{cases.all_rejected.winner|firm}}, prints {{cases.all_rejected.value|taka}}, and records the contract as signed on {{cases.all_rejected.signed|date}}. The tender notice for this contract is one of the {{counts.portal_refused|n}} the portal does not serve, so the award page is the only account of the work.",
      bn: "{{cases.all_rejected.sold|n}}টি নথি বিক্রি, {{cases.all_rejected.bids|n}}টি দর জমা, গ্রহণযোগ্য একটিও নয় — আর তার নিচেই স্বাক্ষরিত চুক্তি। ওই পৃষ্ঠার সঙ্গে দুটি পাঠ খাপ খায়। হয় শূন্যটি লেখার ভুল, নয়তো এটিই মূল্যায়নের বিবরণ। কোনটি, তা পৃষ্ঠাটি বলে না। সেখানে নাম আছে {{cases.all_rejected.winner|firm}}-এর, দর {{cases.all_rejected.value|taka}}, আর চুক্তি স্বাক্ষরের তারিখ {{cases.all_rejected.signed|date}}। এই চুক্তির দরপত্র বিজ্ঞপ্তিটি সেই {{counts.portal_refused|n}}টির একটি, যেগুলো পোর্টাল খুলতে দেয় না — ফলে কাজের একমাত্র বিবরণ ওই চুক্তির পৃষ্ঠাটুকুই।",
    },
    after: [
      {
  ...
  peer_gap: {
    ...
    markRead: {
      en: "Two bids is not remarkable on its own. What makes this notice worth looking at is the company it keeps. Set it beside the {{cases.peer_gap.peer_size|n}} notices closest to it in this set — same authority, same procurement method, same size band — and the middle one of those drew {{cases.peer_gap.peer_median|n}} bids. This one drew two. Then look for the easy explanation. If tight qualification criteria are what empty a field, this notice should be full of them. It publishes none. Where the conditions belong, the page says only that they are as per the instructions to tenderers and the tender data sheet, and neither of those is in the published file. The thinnest field in the set, measured against its peers, sits behind a notice with no published bar at all.",
      bn: "দুটি দর নিজে থেকে বিশেষ কিছু নয়। এই বিজ্ঞপ্তিটিকে দেখার মতো করে তুলেছে তার আশপাশের বিজ্ঞপ্তিগুলো। এই সম্ভারে যেগুলো এর সবচেয়ে কাছাকাছি — একই সংস্থা, একই ক্রয়পদ্ধতি, একই আকারের ঘর — সেই {{cases.peer_gap.peer_size|n}}টি বিজ্ঞপ্তির মধ্যবর্তীটিতে দর পড়েছে {{cases.peer_gap.peer_median|n}}টি। এটিতে দুটি। এবার সহজ ব্যাখ্যাটি খোঁজা যাক। কঠিন যোগ্যতার শর্তই যদি প্রতিযোগিতা খালি করে, তবে এই বিজ্ঞপ্তিটি শর্তে ভরা থাকা উচিত। এতে একটিও নেই। যেখানে শর্ত থাকার কথা, সেখানে কেবল লেখা আছে শর্ত দরদাতাদের নির্দেশনা ও টেন্ডার ডেটা শিট অনুযায়ী, আর এর কোনোটিই প্রকাশিত ফাইলে নেই। সমগোত্রীয়দের মাপে সম্ভারের সবচেয়ে পাতলা প্রতিযোগিতাটি রয়েছে এমন এক বিজ্ঞপ্তির পেছনে, যেটি কোনো শর্তই প্রকাশ করেনি।",
    },
    after: [
      {
  ...
  repeat_clause: {
    ...
    markRead: {
      en: "A shared sentence is not a problem in itself. Procurement is meant to be standardised, and reused wording is what standardisation looks like on a page. It matters here for a narrower reason. The shared stock is not only boilerplate about deadlines and forms. It includes the sentences that decide who may bid. And then this notice does something the simple version of this story would not allow. It is one of the most heavily conditioned in the whole set: a licence category, experience working for a government client, a cap on how many contracts a bidder may hold at once. {{cases.repeat_clause.sold|n}} companies bought the document. {{cases.repeat_clause.bids|n}} bid. Every one of the {{cases.repeat_clause.bids|n}} was ruled responsive, and nobody was set aside. The hardest notice to qualify for produced the cleanest competition in the file.",
      bn: "ভাগ করা বাক্য নিজে থেকে সমস্যা নয়। ক্রয়প্রক্রিয়া মানসম্মত হওয়ারই কথা, আর পুনর্ব্যবহৃত ভাষা পৃষ্ঠায় সেই মানসম্মততারই চেহারা। এখানে বিষয়টি জরুরি সংকীর্ণ একটি কারণে। ভাগ করা ভাণ্ডারটি কেবল সময়সীমা আর ফরম নিয়ে বাঁধা কথা নয়। তার মধ্যে সেই বাক্যগুলোও আছে, যেগুলো ঠিক করে দেয় কারা দর দিতে পারবে। তারপর এই বিজ্ঞপ্তিটি এমন কিছু করে, এই গল্পের সহজ সংস্করণে যার জায়গা নেই। পুরো সংকলনে সবচেয়ে বেশি শর্ত চাপানো বিজ্ঞপ্তিগুলোর একটি এটি: লাইসেন্সের শ্রেণি, সরকারি প্রতিষ্ঠানের হয়ে কাজের অভিজ্ঞতা, একসঙ্গে কতগুলো চুক্তি হাতে রাখা যাবে তার সীমা। {{cases.repeat_clause.sold|n}}টি প্রতিষ্ঠান নথি কিনেছে। দর দিয়েছে {{cases.repeat_clause.bids|n}}টি। ওই {{cases.repeat_clause.bids|n}}টির প্রত্যেকটিই গ্রহণযোগ্য বিবেচিত হয়েছে, একজনকেও সরিয়ে রাখা হয়নি। যে বিজ্ঞপ্তিতে যোগ্য হওয়া সবচেয়ে কঠিন, সেখানেই হয়েছে সংকলনের সবচেয়ে পরিষ্কার প্রতিযোগিতা।",
    },
    after: [
      {
  ...
  price_band: {
    ...
    markRead: {
      en: "Price ten per cent above the estimate and you are out. Price ten per cent below it and you are out. The estimate itself is not on the page, and it appears in none of the {{counts.pdfs|n}} documents. So the bar every bidder had to clear is a number none of them was shown, and the one company that cleared it is the one that won. The sentence is not unique to this tender. It stands, with the same misspellings, in {{cases.price_band.reuse|n}} notices in this set, and a flat band of this kind appears in {{violations.rules.code=R05.deviations|n}} of them altogether, worth {{violations.rules.code=R05.crore|cr}} together. In {{violations.rules.code=R05.in_force|n}} of those the rule document is dated at or before the notice it would govern. Exactly one of the {{violations.rules.code=R05.in_force|n}} went on to become a signed contract. It is this one.",
      bn: "প্রাক্কলনের চেয়ে দশ শতাংশ বেশি দর দিলে আপনি বাদ। দশ শতাংশ কম দিলেও বাদ। প্রাক্কলনটি নিজে ওই পৃষ্ঠায় নেই, আর {{counts.pdfs|n}}টি নথির একটিতেও নেই। অর্থাৎ প্রত্যেক দরদাতাকে যে সীমা ছুঁতে হতো, সেটি এমন একটি সংখ্যা যা তাদের কাউকে দেখানো হয়নি — আর যে একটি প্রতিষ্ঠান সেটি ছুঁতে পেরেছে, তারাই কাজটি পেয়েছে। বাক্যটি কেবল এই দরপত্রের নয়। একই বানান-ভুল নিয়ে এটি এই সম্ভারের {{cases.price_band.reuse|n}}টি বিজ্ঞপ্তিতে আছে, আর এ ধরনের নির্দিষ্ট দরসীমা মোট {{violations.rules.code=R05.deviations|n}}টিতে দেখা যায়, যেগুলোর মিলিত মূল্য {{violations.rules.code=R05.crore|cr}}। ওগুলোর {{violations.rules.code=R05.in_force|n}}টিতে নিয়মের দস্তাবেজটির তারিখ সেই বিজ্ঞপ্তির সমান বা তার আগে, যেটির ওপর তা খাটবে। ওই {{violations.rules.code=R05.in_force|n}}টির ঠিক একটি স্বাক্ষরিত চুক্তিতে গড়িয়েছে। সেটি এটিই।",
    },
    after: [
      {
  ...
  biggest: {
    ...
    markRead: {
      en: "For a job this size that figure is not obviously out of proportion, and nothing here suggests it was written for anyone. It is quoted because of what it settles. It was not the only condition: a bidder also had to hold {{cases.biggest.liquid_crore|cr}} in cash or a credit line, show one finished contract of a similar kind worth {{cases.biggest.similar_crore|cr}}, and have {{cases.biggest.years|n}} years of construction behind it. Very few firms in any country can price a {{cases.biggest.crore|cr}} river-bank road, so a short field here is expected rather than suspicious — and the field was short. Both bids were ruled responsive. Nobody was set aside, and the contract was signed {{cases.biggest.days|n}} days after the award letter, well inside the window. On this contract the paperwork narrowed nothing. What it shows is how few names sit at the top of the table. {{concentration.top1.name|firm}} signed it. This one contract is {{cases.biggest.value_share|pct2}} of every taka in the set, and the same firm holds {{concentration.top1.contracts|n}} contracts here, worth {{concentration.top1.crore|cr}} together, all with one authority. One of them is the road this article opened on. That is not an allegation about the firm. It is the arithmetic of a short list.",
      bn: "এই আকারের কাজে ওই অঙ্ক স্পষ্টভাবে অসংগত নয়, আর এটি কারও জন্য লেখা হয়েছিল এমন কিছুও এখানে নেই। এটি উদ্ধৃত হচ্ছে যা এটি নিষ্পত্তি করে সেই কারণে। শর্ত কেবল এটিই ছিল না: দরদাতার হাতে নগদ বা ঋণসীমা হিসেবে থাকতে হতো {{cases.biggest.liquid_crore|cr}}, দেখাতে হতো একই ধরনের একটি সম্পন্ন চুক্তি যার মূল্য {{cases.biggest.similar_crore|cr}}, আর নির্মাণকাজে {{cases.biggest.years|n}} বছরের অভিজ্ঞতা। {{cases.biggest.crore|cr}} মূল্যের নদীতীরের সড়কের দর দিতে পারে এমন প্রতিষ্ঠান কোনো দেশেই বেশি নেই, তাই এখানে প্রতিযোগিতা পাতলা হওয়া সন্দেহজনক নয়, প্রত্যাশিতই — আর পাতলাই ছিল। দুটি দরই গ্রহণযোগ্য বিবেচিত হয়। কাউকে সরিয়ে রাখা হয়নি, আর কাজের চিঠির {{cases.biggest.days|n}} দিন পরেই চুক্তি সই হয়, সময়ের অনেক ভেতরে। এই চুক্তিতে কাগজপত্র কিছুই সংকুচিত করেনি। যা দেখায় তা হলো, তালিকার শীর্ষে নাম কত কম। চুক্তিটি করে {{concentration.top1.name|firm}}। এই একটি চুক্তিই সম্ভারের প্রতি টাকার {{cases.biggest.value_share|pct2}}, আর একই প্রতিষ্ঠানের হাতে এখানে {{concentration.top1.contracts|n}}টি চুক্তি, মিলিত মূল্য {{concentration.top1.crore|cr}}, সবই একই সংস্থার সঙ্গে। তার একটি হলো সেই সড়ক, যেটি দিয়ে এই লেখা শুরু হয়েছে। এটি প্রতিষ্ঠানটির বিরুদ্ধে কোনো অভিযোগ নয়। এটি ছোট তালিকার হিসাব।",
    },
    after: [
      {
      ...
      {
        en: "Which is the honest way into the rest of this section. Very few firms in any country can price a {{cases.biggest.crore|cr}} river-bank road, so finding the same names on the largest packages is expected rather than suspicious. What follows is not an allegation about any of them. It is the arithmetic of how few names the top of this table has.",
  ...
  preselection: {
    ...
    markRead: {
      en: "Read it closely before drawing anything from it. It is not one closed list. Enlistment with any government, semi-government or autonomous body will do, and a reputed firm is admitted as well. What it shuts out is a company that has never been enlisted with any public body anywhere — a real bar, and a much softer one than the words first suggest. The same sentence appears in {{cases.preselection.reuse|n}} of the {{counts.tenders|n}} notices, so it was not written for this job. This notice is the only one of the {{counts.tenders|n}} that meets all seven of the conditions in the figure above: a requirement that looks restrictive, few bids, documents sold that never came back as bids, a bidder ruled non-responsive, one responsive bidder left, a winner that wins repeatedly, and a winner whose wins arrive in thin fields. Every one of the seven has an innocent reading. Small jobs draw few bidders. A document bought is not a promise to bid. And this is a small job — {{cases.preselection.value_share|pct2}} of the money. All the seven do is sort {{counts.tenders|n}} notices by how many answers invite another question, and this street-light contract sorts first. {{cases.preselection.winner|firm}} holds {{cases.preselection.winner_contracts|n}} contracts here, all with the same authority, worth {{cases.preselection.winner_crore|cr}} together, and {{cases.preselection.winner_thin|n}} of the {{cases.preselection.winner_contracts|n}} were won in a field of two bidders or fewer. The bid that was set aside is not named, its price is not published, and no reason is given.",
      bn: "কিছু সিদ্ধান্ত টানার আগে বাক্যটি মন দিয়ে পড়ুন। এটি একটিমাত্র বন্ধ তালিকা নয়। যেকোনো সরকারি, আধা-সরকারি বা স্বায়ত্তশাসিত সংস্থায় তালিকাভুক্তি চলবে, আর সুপরিচিত প্রতিষ্ঠানও গ্রহণযোগ্য। বাদ পড়ে সেই প্রতিষ্ঠান, যে কোনো দিন কোথাও কোনো সরকারি সংস্থায় তালিকাভুক্ত হয়নি — এটি সত্যিকারের একটি বাধা, আর প্রথম পাঠে যা মনে হয় তার চেয়ে অনেক নরম। একই বাক্য আছে {{counts.tenders|n}}টি বিজ্ঞপ্তির {{cases.preselection.reuse|n}}টিতে, অর্থাৎ এটি এই কাজটির জন্য লেখা হয়নি। উপরের রেখাচিত্রের সাতটি শর্তের সবগুলো পূরণ করে এমন বিজ্ঞপ্তি ওই {{counts.tenders|n}}টির মধ্যে কেবল এটিই: দেখতে সীমাবদ্ধ মনে হওয়া একটি শর্ত, অল্প দর, বিক্রি হওয়া দলিল যা দর হয়ে ফেরেনি, একজন দরদাতা অগ্রহণযোগ্য বিবেচিত, শেষে একটিই গ্রহণযোগ্য দর, বারবার জেতা বিজয়ী, এবং যে বিজয়ীর জয় আসে পাতলা প্রতিযোগিতায়। সাতটির প্রত্যেকটির একটি নিরপরাধ পাঠ আছে। ছোট কাজে দরদাতা কম আসে। নথি কেনা মানে দর দেওয়ার প্রতিশ্রুতি নয়। আর এটি ছোট কাজই — অর্থের {{cases.preselection.value_share|pct2}}। সাতটি শর্ত শুধু {{counts.tenders|n}}টি বিজ্ঞপ্তিকে সাজায় — কোনটিতে কতগুলো উত্তর আরেকটি প্রশ্ন ডেকে আনে, সেই হিসেবে। আর এই সড়কবাতির চুক্তিটি সবার আগে। এখানে {{cases.preselection.winner|firm}}-এর হাতে {{cases.preselection.winner_contracts|n}}টি চুক্তি, সবই একই সংস্থার, মিলিত মূল্য {{cases.preselection.winner_crore|cr}} — আর ওই {{cases.preselection.winner_contracts|n}}টির {{cases.preselection.winner_thin|n}}টি জেতা হয়েছে দুই বা তার কম দরদাতার প্রতিযোগিতায়। যে দরটি সরিয়ে রাখা হয়েছিল তার নাম নেই, দাম প্রকাশ করা হয়নি, কারণও লেখা নেই।",
    },
    after: [
      {
...
export const STORY = [
...

  {
    ...
    tag: "derived",
    h: {
      en: "{{bars.financial_above_1x|n}} notices asked a bidder to show more money than the contract was worth",
      bn: "{{bars.financial_above_1x|n}}টি বিজ্ঞপ্তিতে দরদাতাকে চুক্তির মূল্যের চেয়ে বেশি অর্থ দেখাতে বলা হয়েছে",
    },
    p: [
      {
        en: "Of the {{bars.financial.n|n}} tenders where both the money demanded and the contract value are published, the middle demand is {{bars.financial.median|x2}} the contract value. {{bars.financial_above_2x|n}} ask for more than twice the contract, and {{bars.financial_above_5x|n}} for more than five times it. A company that could do the work but cannot show money on that scale is not eligible to bid.",
        bn: "যে {{bars.financial.n|n}}টি দরপত্রে চাওয়া অর্থ ও চুক্তিমূল্য দুটিই প্রকাশিত, সেখানে দাবির মাঝের মান চুক্তিমূল্যের {{bars.financial.median|x2}}। {{bars.financial_above_2x|n}}টিতে চুক্তির দ্বিগুণের বেশি চাওয়া হয়েছে, {{bars.financial_above_5x|n}}টিতে পাঁচ গুণের বেশি। যে প্রতিষ্ঠান কাজটি করতে পারত, কিন্তু এই মাপের অর্থ দেখাতে পারে না, সে দর দেওয়ার যোগ্যই নয়।",
      },
      {
